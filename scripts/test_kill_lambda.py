...
print("Testing Kill Lambda Function URL...")
print(f"URL: {KILL_URL}")

# Create signed request
signed_request = sign_request(KILL_URL, method='POST', body='{}')
...
response = requests.post(KILL_URL, headers=headers, data='{}')

print(f"Status Code: {response.status_code}")
print(f"Response: {response.text}")

if response.status_code == 200:
    print("✅ Kill function call successful!")
else:
    print("❌ Kill function call failed")